...
from fcsm_eos_api_client.models.config_configuration import ConfigConfiguration  # noqa: E501
...
class TestConfigConfiguration(unittest.TestCase):
    ...
    def testConfigConfiguration(self):
        ...
        # model = fcsm_eos_api_client.models.config_configuration.ConfigConfiguration()  # noqa: E501
        pass
